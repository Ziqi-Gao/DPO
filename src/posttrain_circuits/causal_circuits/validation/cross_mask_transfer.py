"""Held-out cross-checkpoint and cross-method exact mask transfer."""
...
from posttrain_circuits.causal_circuits.contracts import AblationSpec
from posttrain_circuits.causal_circuits.interventions.masks import top_mask
