"""Pinned MIB EAP-IG discovery over fixed local pairs."""
...
from posttrain_circuits.causal_circuits.metrics.probes import CIRCUIT_PROBE_SCHEMA_VERSION
...
class MibEapIgAdapter:
    ...
    def run(
        ...
        *,
        ...
        if scores.metadata.get("uncertainty_method") != "prompt_bootstrap_standard_deviation":
            raise RuntimeError("MIB result does not report bootstrap-replicate standard deviation")
        return scores
